...
const OldBooks = () => {
    ...
    return books.filter((book) => (filterYear - releaseYear) >= 60).sort((a, b) => a.releaseYear - b.releaseYear);
}

// desafio 3
const nameBooksAndYearBirth = (birthYear) => {
